...
You should compile the project after that to make auto-completion accept the new class.

[[ue-generate-interface,`ue-generate-interface`]]`ue-generate-interface`::
Create a new Unreal interface for the project.
You should compile the project after that to make auto-completion accept the new interface.
